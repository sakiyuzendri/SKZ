...
# SET IMAGES NAMES
OPENBBTERMINAL_IMAGE=${OPENBBTERMINAL_DOCKER_REGISTRY,,}/openbbterminal-poetry
OPENBBTERMINAL_IMAGE_VERSION=${OPENBBTERMINAL_DOCKER_REGISTRY,,}/openbbterminal-poetry:${OPENBBTERMINAL_DOCKER_RELEASE_VERSION,,}
OPENBBTERMINAL_IMAGE_LATEST=${OPENBBTERMINAL_DOCKER_REGISTRY,,}/openbbterminal-poetry:latest
