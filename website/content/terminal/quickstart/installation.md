...
```bash
curl -o docker-compose.yaml https://github.com/OpenBB-finance/OpenBBTerminal/blob/main/build/docker/docker-compose.yaml
docker compose run poetry
```

The command line with `curl` is downloading this file : [`docker-compose.yaml`](https://github.com/OpenBB-finance/OpenBBTerminal/blob/main/build/docker/docker-compose.yaml).
